...
file <- "GBM_grid__1_AutoML_20210119_071030_model_3"
#mod  <- h2o.loadModel("/srv/shiny-server/app/GBM_grid__1_AutoML_20210119_071030_model_3")
mod  <- h2o.upload_mojo("GBM_1_AutoML_20210218_162934.zip")
