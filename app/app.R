# Shiny app to explore H2O model for churn predictions
# april 2021
# Peer Christensen

# NOTE: uses h2o version "3.32.0.1"
...
#path = "/Users/peerchristensen/Desktop/Projects/Docker/simpleAppH2O/app/"
mod  <- h2o.loadModel("GBM_grid__1_AutoML_20210409_084451_model_6")

train_hf <- h2o.uploadFile("train.csv")

# test <- vroom::vroom("/Users/peerchristensen/Desktop/Projects/Docker/simpleAppH2O/app/test.csv")  %>%
